        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceEntryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    PerformedOperations = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateAdded", "Email", "IsActive", "Name", "Password", "Phone", "RoleId", "Surname", "UserName" },
                values: new object[] { 1, new DateTime(2025, 7, 7, 18, 39, 34, 738, DateTimeKind.Local).AddTicks(8797), "adminuser@satis.com", true, "Admin", "123456", "+905319677149", 1, "User", "AdminUser" });
